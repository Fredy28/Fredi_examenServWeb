 ...
 * @author fredi
 */
@WebServlet(name = "BeanServlet", urlPatterns = {"/bean_servlet"})
public class BeanServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (claveParam != null) {
            System.out.println("Clave recibida: " + claveParam); // Verifica en la consola
        } else {
            System.out.println("No se recibió la clave");
        }
        ...
        try {
            ...
            if (claveParam != null) {
                int clave = Integer.parseInt(claveParam);
                String sql = "SELECT clave, carrera, duracion, campo, nivel FROM carrera WHERE clave = ?";
                try ( PreparedStatement ps = conn.prepareStatement(sql)) {
                    ...
                    e.printStackTrace();
                    response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Error en la consulta a la base de datos");
                }
            }
